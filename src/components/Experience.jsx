...
const timeline = [
  {
    ...
    company: "Brother Customer Care (PT Teknika Sarana Gardian)",
    items: [
      "Handling instalasi, troubleshooting, dan perbaikan printer/device Brother",
      "On-site & remote support untuk customer resmi vendor Brother Indonesia",
      "Maintenance rutin dan pengecekan kualitas unit sebelum & sesudah servis",
      "Koordinasi dengan tim vendor untuk penanganan klaim garansi",
    ],
  },
  {
    date: "2024 – Sekarang",
